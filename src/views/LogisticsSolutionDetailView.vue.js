...
const __VLS_0 = __VLS_asFunctionalComponent(InnerHero, new InnerHero({
    ...
    title: (`${__VLS_ctx.page.name} that supports the freight plan.`),
...
for (const [need] of __VLS_getVForSourceType((__VLS_ctx.page.needs))) {
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.section, __VLS_intrinsicElements.section)({
    ...{ class: "section-block included-services-section" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
...
for (const [item] of __VLS_getVForSourceType((__VLS_ctx.page.capabilities))) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.article, __VLS_intrinsicElements.article)({
        key: (item),
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.img, __VLS_intrinsicElements.img)({
    ...
    alt: (`${__VLS_ctx.page.name} benefits`),
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
__VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({
    ...{ class: "eyebrow" },
...
for (const [benefit] of __VLS_getVForSourceType((__VLS_ctx.page.benefits))) {
...
/** @type {__VLS_StyleScopedClasses['included-services-section']} */ ;
